...
@Component({
  selector: 'app-kriteria-subkriteria-user',
  templateUrl: './kriteria-subkriteria-user.component.html',
  styleUrls: ['./kriteria-subkriteria-user.component.scss'],
})
export class KriteriaSubkriteriaUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.kr.tampil_subkriteria_bobot_user(this.arr_id).subscribe((data) => {      
      this.filter(data);
    });
  }
